...
export default function App() {
  ...
  const steps = [
    {
      ...
      desc: "Department head submits a quotation request with item specifications and budget details.",
    },
    {
      num: "02",
      title: "Accountant Verifies",
      desc: "Accountant reviews and forwards the verified request to registered vendors.",
    },
    {
      num: "03",
      title: "Vendors Respond",
      desc: "Vendors submit competitive quotations with pricing and delivery terms.",
    },
    {
      num: "04",
      title: "Principal Approves",
      desc: "Selected quotation is reviewed and approved by the Principal.",
    },
    {
      num: "05",
      title: "Delivery + OTP",
      desc: "Vendor delivers goods; HOD confirms receipt via OTP before payment is released.",
    },
    {
      num: "06",
      title: "Payment & Archive",
      desc: "Secure payment processed, transaction archived for expense analysis.",
    },
  ];
  ...
  return (
    <div className="font-sans text-[#111110] bg-[#F2F2F2] antialiased overflow-x-hidden [&::-webkit-scrollbar]:w-[6px] [&::-webkit-scrollbar-track]:bg-[#F2F2F2] [&::-webkit-scrollbar-thumb]:bg-[#D3D6DA] [&::-webkit-scrollbar-thumb]:rounded-[3px]">
      ...
      {/* ── Nav ── */}
      <nav
        className={`fixed left-0 right-0 top-0 z-[100] flex h-[68px] items-center px-[clamp(20px,5vw,64px)] transition-all duration-400 ease-[cubic-bezier(0.22,1,0.36,1)] ${scrolled ? "bg-[#F2F2F2]/90 backdrop-blur-[16px] shadow-[0_1px_0_rgba(0,0,0,0.08)]" : ""}`}
      >
        <div className="mx-auto flex w-full max-w-[1280px] items-center justify-between">
          ...
          <ul className="hidden items-center gap-8 list-none lg:flex">
            <li>
              <a
                href="#features"
                className="text-sm font-medium text-[#4C433F] transition-colors duration-200 hover:text-[#111110]"
              >
                Features
              </a>
            </li>
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/auth"
              className="hidden rounded-lg px-4 py-2 text-sm font-medium text-[#4C433F] transition-colors hover:bg-black/5 hover:text-[#111110] lg:inline-block"
            >
              Sign in
            </Link>
            <Link
              href="/auth"
              className="hidden rounded-lg bg-[#111110] px-[22px] py-2.5 text-sm font-semibold text-white transition-all duration-250 hover:-translate-y-[1px] hover:bg-[#FB4D27] active:translate-y-0 lg:inline-block"
            >
              Get started
            </Link>
            ...
            >
              <span
                className={`block h-[2px] w-[22px] rounded-sm bg-[#111110] transition-transform duration-300 ${menuOpen ? "translate-y-[7px] rotate-45" : ""}`}
              />
              <span
                className={`block h-[2px] w-[22px] rounded-sm bg-[#111110] transition-opacity duration-300 ${menuOpen ? "opacity-0" : "opacity-100"}`}
              />
              <span
                className={`block h-[2px] w-[22px] rounded-sm bg-[#111110] transition-transform duration-300 ${menuOpen ? "-translate-y-[7px] -rotate-45" : ""}`}
              />
      ...
      {/* ── Mobile Drawer ── */}
      <div
        className={`fixed inset-0 z-[99] flex-col gap-2 bg-[#F2F2F2] px-6 pb-6 pt-[92px] lg:hidden ${menuOpen ? "flex" : "hidden"}`}
      >
        <a
          href="#features"
          onClick={() => setMenuOpen(false)}
          className="border-b border-black/5 py-3.5 text-lg font-medium text-[#111110]"
        >
          Features
        </a>
        <a
        ...
        <div className="mt-4 flex flex-col gap-2.5">
          <Link
            href="/auth"
            onClick={() => setMenuOpen(false)}
            className="inline-flex items-center justify-center gap-2 rounded-lg border-[1.5px] border-black/20 bg-transparent px-[22px] py-2.5 text-sm font-medium text-[#111110] transition-all hover:-translate-y-[1px] hover:bg-[#111110] hover:text-white"
          >
            Sign in
          </Link>
          <Link
            href="/auth"
            onClick={() => setMenuOpen(false)}
            className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#FB4D27] px-7 py-3.5 text-[15px] font-semibold text-white shadow-[0_4px_20px_rgba(251,77,39,0.35)] transition-all hover:-translate-y-[2px] hover:bg-[#e83d18] hover:shadow-[0_8px_30px_rgba(251,77,39,0.45)]"
          >
            Get started
          </Link>
        </div>
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-[1280px] flex-1 flex-col justify-center gap-14 px-[clamp(20px,5vw,64px)] py-[clamp(48px,8vh,100px)]">
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            ...
            <div className="flex flex-col gap-7">
              ...
              <h1
                className="animate-fade-slide-up text-[clamp(42px,8vw,56px)] font-bold leading-[1.04] tracking-[-0.03em] text-[#111110] lg:text-[clamp(42px,5.5vw,72px)]"
              ...
              <p
                className="animate-fade-slide-up max-w-[420px] text-[17px] font-normal leading-[1.65] text-[#4C433F]"
                style={{ animationDelay: "200ms" }}
              >
                The all-in-one platform for managing vendors, tracking expenses,
                and streamlining quotation approvals — built for government
                institutions.
              </p>

              <div
                className="animate-fade-slide-up flex flex-wrap items-center gap-3.5"
                style={{ animationDelay: "300ms" }}
              >
                <Link
                  href="/auth"
                  className="inline-flex items-center gap-2 rounded-lg bg-[#FB4D27] px-7 py-3.5 text-[15px] font-semibold text-white shadow-[0_4px_20px_rgba(251,77,39,0.35)] transition-all duration-250 hover:-translate-y-0.5 hover:bg-[#e83d18] hover:shadow-[0_8px_30px_rgba(251,77,39,0.45)] active:translate-y-0"
                >
                  Get started free
                  <svg
                    width="16"
                ...
                <Link
                  href="/auth"
                  className="inline-flex items-center gap-2 rounded-lg border-[1.5px] border-black/15 bg-transparent px-6 py-[13px] text-[15px] font-medium text-[#111110] transition-all duration-250 hover:-translate-y-[1px] hover:border-[#111110] hover:bg-[#111110] hover:text-white"
                >
                  <svg
                    width="15"
                    height="15"
              ...
              <div
                className="animate-fade-slide-up flex flex-wrap items-center gap-2"
                style={{ animationDelay: "400ms" }}
              >
                <span className="text-xs font-medium tracking-[0.03em] text-[#929090]">
                  Roles:
                </span>
            ...
            <div
              className="animate-fade-slide-up flex justify-center lg:justify-end"
              style={{ animationDelay: "200ms" }}
            >
                ...
                <div className="flex flex-col gap-3.5 p-5">
                  <div className="grid grid-cols-3 gap-2.5">
                    <div className="rounded-[10px] border border-black/5 bg-[#F2F2F2] p-3.5 pb-3">
                      <div className="font-sans text-[20px] font-bold tracking-[-0.03em] text-[#FB4D27]">
                        ₹1.04L
                      </div>
                      <div className="mt-0.5 text-[10px] font-medium text-[#929090]">
                        Total Paid
                      </div>
                    </div>
                    <div className="rounded-[10px] border border-black/5 bg-[#F2F2F2] p-3.5 pb-3">
                      <div className="font-sans text-[20px] font-bold tracking-[-0.03em] text-[#111110]">
                        10
                      </div>
                      <div className="mt-0.5 text-[10px] font-medium text-[#929090]">
                        Approved
                  ...
                  <div className="overflow-hidden rounded-[10px] border border-black/5 bg-[#F2F2F2] p-3.5">
                    <div className="mb-3 text-[11px] font-semibold uppercase tracking-[0.06em] text-[#929090]">
                      Monthly Quotations
                    </div>
                    <div className="flex h-[56px] items-end gap-1.5">
                      {[28, 45, 36, 58, 40, 65, 50, 72, 55, 48, 60, 45].map(
                        (h, i) => (
                          <div
                            key={i}
                    ...
                    {[
                      {
                        ...
                        dept: "CS Dept · ₹10,000",
                        status: "Approved",
                        pill: "bg-[#28CA41]/12 text-[#1a8c30]",
                      },
                      {
                        title: "Lab Equipment Request",
                        dept: "ECE Dept · ₹4,500",
                        status: "Pending",
                        pill: "bg-[#FFBD2E]/15 text-[#9a6e00]",
                      },
                      {
                        title: "Office Supplies Quotation",
                        dept: "Admin · ₹2,300",
                        status: "Review",
                        pill: "bg-[#FB4D27]/12 text-[#FB4D27]",
                      },
                    ].map((item, i) => (
                      <div
                        key={i}
                        className="flex items-center justify-between rounded-lg border border-black/5 bg-[#F2F2F2] px-3 py-2.5"
                      >
                        <div className="flex flex-col gap-0.5">
                          <span className="text-[12px] font-semibold text-[#111110]">
                            {item.title}
                          </span>
                          <span className="text-[10px] text-[#929090]">
                            {item.dept}
                          </span>
                        </div>
                        <span
                          className={`rounded-full px-2 py-[3px] text-[10px] font-semibold uppercase tracking-[0.04em] ${item.pill}`}
                        >
                          {item.status}
                        </span>
                      </div>
      ...
      {/* ── Features ── */}
      <section
        className="px-[clamp(20px,5vw,64px)] py-[clamp(64px,10vw,120px)]"
        id="features"
      >
        <div className="mx-auto max-w-[1280px]">
          ...
          <h2 className="mb-14 max-w-[600px] font-sans text-[clamp(32px,4vw,52px)] font-bold leading-[1.08] tracking-[-0.03em] text-[#111110]">
            Everything you need
            <br />
            <em className="font-light not-italic text-[#929090]">
              in one place
            </em>
          </h2>
      ...
      {/* ── Workflow ── */}
      <section
        className="relative overflow-hidden bg-[#111110] px-[clamp(20px,5vw,64px)] py-[clamp(64px,10vw,120px)]"
        id="workflow"
      >
        <div className="mx-auto max-w-[1280px]">
          <div className="mb-4 inline-flex items-center gap-2 font-mono text-[11px] font-medium uppercase tracking-[0.12em] text-[#FB4D27] before:block before:h-px before:w-6 before:bg-[#FB4D27] before:content-['']">
          ...
          <h2 className="mb-14 max-w-[600px] font-sans text-[clamp(32px,4vw,52px)] font-bold leading-[1.08] tracking-[-0.03em] text-white">
            Six steps from
            <br />
            <em className="font-light not-italic text-white/35">
              request to payment
            </em>
          </h2>
          <div className="grid overflow-hidden rounded-[14px] border border-white/5 bg-white/5 gap-px sm:grid-cols-2 lg:grid-cols-3">
            {steps.map((s, i) => (
              <div
                key={i}
                data-num={s.num}
                className="relative overflow-hidden bg-[#2a2826] p-7 transition-colors duration-250 hover:bg-[#322e2b] md:p-8 before:absolute before:-bottom-2.5 before:right-3 before:pointer-events-none before:font-sans before:text-[80px] before:font-bold before:leading-none before:tracking-[-0.05em] before:text-white/5 before:content-[attr(data-num)]"
              >
                <div className="mb-3.5 font-mono text-[11px] font-medium tracking-[0.1em] text-[#FB4D27]">
                  {s.num}
                </div>
                <h3 className="mb-2 text-base font-semibold tracking-[-0.01em] text-white">
                  {s.title}
                </h3>
            ...
            {[
              {
                ...
                actions: [
                  "Create & submit quotation requests",
                  "Review vendor responses",
                  "Select preferred vendor (L1/L2)",
                  "Verify product delivery via OTP",
                ],
              },
              {
                name: "Accountant",
                ...
                actions: [
                  "Verify and forward quotation requests",
                  "Review vendor quotations",
                  "Process payments via Razorpay",
                  "Generate expense reports & exports",
                ],
              },
              {
                name: "Principal",
                ...
                actions: [
                  ...
                  "Oversee institutional spending",
                ],
              },
              {
                name: "Vendor",
                ...
                actions: [
                  "View and respond to quotation requests",
              ...
              <div
                key={i}
                className="group rounded-[14px] border border-black/5 bg-white p-8 transition-all duration-250 hover:-translate-y-[3px] hover:border-[#FB4D27] hover:shadow-[0_8px_32px_rgba(251,77,39,0.1)]"
              >
                <div className="mb-5 flex items-center justify-between">
                  <span className="text-lg font-bold tracking-[-0.02em] text-[#111110]">
                    {role.name}
                  </span>
                  <div
                ...
                <div className="flex flex-col gap-2">
                  {role.actions.map((a, j) => (
                    <div
                      key={j}
                      className="flex items-center gap-2.5 text-[13px] text-[#4C433F]"
                    >
                      <span
      ...
      <div className="relative mx-[clamp(20px,5vw,64px)] mb-[clamp(48px,8vw,96px)] flex flex-wrap items-center justify-center gap-12 overflow-hidden rounded-[20px] bg-[#111110] px-[clamp(32px,5vw,72px)] py-[clamp(48px,8vw,88px)] text-center sm:justify-between sm:text-left">
        ...
        <div className="relative z-10 flex w-full justify-center sm:w-auto">
          <Link
            href="/auth"
            className="group inline-flex whitespace-nowrap items-center gap-2.5 rounded-lg bg-white px-8 py-4 font-sans text-base font-semibold text-[#111110] transition-all duration-250 hover:-translate-y-0.5 hover:bg-[#FB4D27] hover:text-white"
          >
            Create your account
            <svg
              width="18"
